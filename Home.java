...
import com.example.vpvu2.androidpizza.ViewHolder.MenuViewHolder;
...
public class Home extends AppCompatActivity
           ...
           viewHolder.menuName.setText(model.getName());
               ...
               viewHolder.setItemClickListener(new ItemClickListener(){
                   ...
                   public void onClick(View view, int position, boolean isLongClick) {
                        switch (position) {
                            case 2:
                                Intent pizzaList = new Intent(Home.this, PizzaList.class);
                                pizzaList.putExtra("CategoryId", adapter.getRef(position).getKey());
                                startActivity(pizzaList);
                                break;
                            case 0:
                                ...
                                break;
                            case 1:
                                Intent saladList = new Intent(Home.this, SaladList.class);
                                saladList.putExtra("CategoryId", adapter.getRef(position).getKey());
                                startActivity(saladList);
                                break;
                        }
                    }
                  });
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_menu) {
            ...
            Intent order_Intent = new Intent(Home.this,OrderStatusInfo.class);
            startActivity(order_Intent);
        } else if (id == R.id.nav_cart) {
            Intent cart_Intent = new Intent(Home.this,Cart.class);
            startActivity(cart_Intent);
        } else if (id == R.id.nav_log_out) {
            Intent sign_In = new Intent(Home.this,SignIn.class);
