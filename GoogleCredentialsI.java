...
public class GoogleCredentialsI implements ClientInterceptor {
    ...
    GoogleCredentialsI(Credentials credentials) {
    ...
    private URI serviceUri(Channel channel, MethodDescriptor<?, ?> method)
        ...
        if (authority == null) {
            throw Status.UNAUTHENTICATED
                    .withDescription("Channel is not authorized")
                    .asException();
        }
        ...
        try {
            ...
            throw Status.UNAUTHENTICATED
                    .withDescription("Can't construct service URI for authorization")
