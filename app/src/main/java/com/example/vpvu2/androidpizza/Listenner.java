...
public class Listenner extends AppCompatActivity {
    ...
    public static final String TAG = "Listenner";
    ...
    private CloudSpeechAPI speechAPI;
    ...
    private final CloudSpeechAPI.Listener mSpeechServiceListener =
            new CloudSpeechAPI.Listener() {
                @Override
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_listenner);
        ButterKnife.bind(this);
        speechAPI = new CloudSpeechAPI(Listenner.this);
